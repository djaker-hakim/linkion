...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var coreTrait = {
    ...
    has(name) {
      return this.components.has(name) && (this.getComponentByProp("ref", name) || this.getComponentByProp("componentName", name));
    },
  ...
  function componentProxy(component, linkion2) {
    return new Proxy(component, {
      get(target, method) {
        ...
        if (method === "render") {
          return (...args) => linkion2.render(ref, ...args);
        }
        if (method === "upload") {
          return (...args) => linkion2.fileUpload(ref, ...args);
        }
        if (method === "onUpdate") {
          return (callback) => linkion2.onUpdate(ref, callback);
        }
        if (method === "watch") {
          return (prop, callback) => linkion2.onUpdate(ref, callback, prop);
        }
        return (...args) => linkion2.call(ref, method, args);
      },
      set(_, prop, value) {
        const props = {};
        ...
        props[prop] = value;
        linkion2.updateComponent(props);
      }
    });
  }
  ...
  function linkionProxy(linkion2) {
    return new Proxy(linkion2, {
