(() => {
  ...
  var coreTrait = {
    ...
    initComponent(el) {
      const data2 = el.getAttribute("lnkn-data");
      if (!data2) return;
      const component = JSON.parse(data2);
      this.add(component);
    ...
    get(name) {
      ...
      let comp = {};
      if ((comp = this.getComponentByProp("ref", name)) || (comp = this.getComponentByProp("componentName", name))) return comp;
      return null;
    },
    ...
    async fetch(train) {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          return this.displayError(data2);
        }
  ...
  var apiLoadTrait = {
    async load(name, args = {}) {
      ...
      try {
        const data2 = await this.fetch(train);
        this.add(data2.props);
  ...
  var apiCallTrait = {
    async call(name, method, args = []) {
      ...
      try {
        const data2 = await this.fetch(train);
        this.handleEvents(data2.events);
        this.updateComponent(data2.props);
        if (!component.componentCached || data2.template) {
          this.renderTemplate(component, data2.template);
        }
        return data2.result;
      } catch (e) {
        console.error(e);
  ...
  var renderTrait = {
    ...
    async render(name, args = {}, el) {
      ...
      try {
        const data2 = await this.fetch(train);
        component ? this.updateComponent(data2.props) : this.add(data2.props);
        this.renderTemplate(this.get(name), data2.template, el);
        return data2.result;
      } catch (e) {
        console.error(e);
        return e;
  ...
  // packages/djaker-hakim/linkion/src/js/eventsAndListeners/events.js
  var eventsTrait = {
    //-----  internal EVENTS   -----//
    triggers: {},
    ...
    on(ref, event, callback) {
      ...
      if (this.has(ref)) {
        ...
        if (!this.triggers[ref][event]) this.triggers[ref][event] = /* @__PURE__ */ new Map();
    ...
    off(ref, event = null, id = null) {
      ...
      if (this.has(ref) && this.triggers[ref][event]) {
        if (id) {
          this.triggers[ref][event].has(id) ? this.triggers[ref][event].delete(id) : "";
        } else {
    ...
    listeners: [],
    getListeners(event) {
      return this.listeners.filter((listener2) => {
        return listener2.event == event;
      });
    },
    ...
    dispatch(event, detail = {}) {
      for (let listener2 of this.getListeners(event)) {
        let components = this.getComponentsByProp("componentName", listener2.componentName);
        for (let component of components) {
          this.call(component.componentName, listener2.method, [detail]);
        }
      }
    },
  ...
  // packages/djaker-hakim/linkion/src/js/watchers/onUpdate.js
  var onUpdateTrait = {
    ...
    onUpdate(name, callback, prop = "_all_") {
      if (this.has(name)) {
        ...
        let eventId = this.on(name, "lnkn-updated", (detail) => {
          ...
          let status;
          component.ref ? status = component.ref == ref : status = component.componentName == componentName;
  ...
  // packages/djaker-hakim/linkion/node_modules/alpinejs/dist/module.esm.js
  ...
  var mergeProxyTrap = {
    ...
    has({ objects }, name) {
      if (name == Symbol.unscopables)
        return false;
      return objects.some(
        (obj2) => Object.prototype.hasOwnProperty.call(obj2, name) || Reflect.has(obj2, name)
      );
    },
    ...
    set({ objects }, name, value, thisProxy) {
      const target = objects.find(
        (obj2) => Object.prototype.hasOwnProperty.call(obj2, name)
  ...
  function initInterceptors(data2) {
    ...
    let recurse = (obj2, basePath = "") => {
      Object.entries(Object.getOwnPropertyDescriptors(obj2)).forEach(([key, { value, enumerable }]) => {
        ...
        if (typeof value === "object" && value !== null && value._x_interceptor) {
          obj2[key] = value.initialize(data2, path, key);
        } else {
          if (isObject2(value) && value !== obj2 && !(value instanceof Element)) {
            recurse(value, path);
          }
        }
      });
  ...
  function interceptor(callback, mutateObj = () => {
    ...
    return (initialValue) => {
      if (typeof initialValue === "object" && initialValue !== null && initialValue._x_interceptor) {
        let initialize = obj2.initialize.bind(obj2);
        obj2.initialize = (data2, path, key) => {
          let innerValue = initialValue.initialize(data2, path, key);
          obj2.initialValue = innerValue;
          return initialize(data2, path, key);
        };
      } else {
        obj2.initialValue = initialValue;
      }
      return obj2;
    };
  }
  function get(obj2, path) {
    return path.split(".").reduce((carry, segment) => carry[segment], obj2);
  }
  function set(obj2, path, value) {
    ...
    if (path.length === 1)
      ...
      if (obj2[path[0]])
        return set(obj2[path[0]], path.slice(1), value);
      else {
        obj2[path[0]] = {};
        return set(obj2[path[0]], path.slice(1), value);
      }
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function injectBindingProviders(obj2) {
  ...
  function applyBindingsObject(el, obj2, original) {
    let cleanupRunners = [];
    while (cleanupRunners.length)
      cleanupRunners.pop()();
    let attributes = Object.entries(obj2).map(([name, value]) => ({ name, value }));
  ...
  function injectDataProviders(obj2, context) {
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/intersect/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/collapse/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/mask/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/persist/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/focus/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/morph/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/anchor/dist/module.esm.js
  var min = Math.min;
  var max = Math.max;
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/sort/dist/module.esm.js
  ...
  function _typeof(obj2) {
    ...
    if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
      _typeof = function(obj22) {
        return typeof obj22;
      };
    } else {
      _typeof = function(obj22) {
        return obj22 && typeof Symbol === "function" && obj22.constructor === Symbol && obj22 !== Symbol.prototype ? "symbol" : typeof obj22;
      };
    }
    return _typeof(obj2);
  }
  ...
  function src_default9(Alpine22) {
  ...
  // packages/djaker-hakim/linkion/node_modules/@alpinejs/resize/dist/module.esm.js
  ...
  // packages/djaker-hakim/linkion/src/js/main.alpine.js
