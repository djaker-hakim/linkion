(() => {
  ...
  // packages/djaker-hakim/linkion/src/js/linkion-script.js
  window.linkion = {
    // Traits
    ...apiToolsTrait,
    ...apiLoadTrait,
    ...
    get(name) {
      ...
      let comp = {};
      if ((comp = this.getComponentByProp("componentName", name)) || (comp = this.getComponentByProp("id", name))) return comp;
      return null;
    },
    ...
    has(name) {
      return this.components.has(name) && (this.getComponentByProp("componentName", name) || this.getComponentByProp("id", name));
    },
